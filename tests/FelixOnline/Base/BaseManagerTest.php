...
class BaseManagerTest extends AppTestCase {
    ...
    public function getManager() {
        ...
        $manager->this()->class = 'FelixOnline\\Base\\AuditLog';
...
LIMIT 0, 10');
    ...
    public function testAll() {
        ...
        $this->assertInstanceOf('FelixOnline\Base\AuditLog', $all[0]);
...
AND (`audit_log`.deleted = 0 OR `audit_log`.deleted IS NULL)
    ...
    public function testOrder() {
        ...
        $this->assertInstanceOf('FelixOnline\Base\AuditLog', $results[0]);
...
AND (`article_author`.deleted = 0 OR `article_author`.deleted IS NULL)
    ...
    public function testBuild() {
        ...
        $this->assertEquals($manager->class, 'FelixOnline\Base\Article');
